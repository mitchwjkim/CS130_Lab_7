...
void application::draw_scene(float time_elapsed) 
{
	...
	glPushMatrix();
	// -150 degree/s around Blue Sphere around y-axis
	...
	// Cyan Dodecahedron
	glPushMatrix();  
	// 20 degrees/s around Blue Sphere around y-axis
	...
	// 300 degree/s around Cyan on x-axis
	...
	// 100 degree/s around Cyan on y-axis    
	...
	// 350 degree/s around Purple on y-axis
